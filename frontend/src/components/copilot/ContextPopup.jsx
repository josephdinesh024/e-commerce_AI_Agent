...
const ContextPopup = ({ show, message, type = 'assist', onConfirm, onClose }) => {
      ...
      <div className="bg-white rounded-lg shadow-2xl border border-gray-200 overflow-hidden">
        ...
        <div className="p-3 bg-gray-50 flex space-x-2 justify-end">
          ...
          <button
            ...
            className="px-4 py-2 text-sm bg-gradient-to-r from-pink-600 to-purple-600 text-white rounded-lg hover:shadow-md transition flex items-center space-x-1"
          >
